...
const Introtext = () => {
  return (
    <div  id = "home" className="relative w-full h-screen justify-center">
      <motion.h1 className="md:text-9xl text-black font-semibold w-full bottom-1/2 mx-auto absolute z-10 text-center mb-2">
        Hi, I am Axel.
      </motion.h1>
      ...
      className='relative top-1/2 rounded-3xl mx-auto z-50 overflow-hidden bg-gray-100 shadow-lg'
      >
        <motion.ul 
